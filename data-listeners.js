...
const {NotNullError, UniqueConstraintError} = require("@themost/common");
const {TraceUtils, TextUtils} = require("@themost/common");
...
class NotNullConstraintListener {
    ...
    beforeSave(event, callback) {
        ...
        let attrs = event.model.attributes.filter(
            function (x) {
